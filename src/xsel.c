...
/* Modified by Christian Heckendorf <heckendorfc@gmail.com>, 2014 */
 ...
 */
static void
print_err (int line, const char * fmt, ...)
{
  va_list ap;
  int errno_save;
  char buf[MAXLINE];
 ...
 */
#define print_debug(x,y...) {if (x <= debug_level) print_err (__LINE__,y);}
